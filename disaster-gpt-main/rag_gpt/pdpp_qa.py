...
class PDPP_QA_System:
    def __init__(self, folder_path):
        self.folder_path = folder_path
        self.docs = self.load_pdf_data()
    ...
    def create_qa_chain(self):
        template = """You are a bot that answers questions about Production Design and Process Planning and Automation in Manufacturing Systems, which is also taught in Industrial Engineering, using only the context provided.
        The context provided is from class lectures PPTs for the course, which contains all required information about it.
